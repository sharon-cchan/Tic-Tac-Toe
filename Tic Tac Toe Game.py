...
def display_board(board):
  print('\n'*100)  #printing 100 empty lines to clear the board and display a new board after each turn
...
def player_input():
    ...
    while marker!='X' and marker!='O': #If player dont give the correct x or O, ask until correct
      marker = input('Player 1: Do you want to be X or O? ').upper()
